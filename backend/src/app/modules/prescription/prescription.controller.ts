...
const updatePrescriptionAndAppointment = catchAsync(
  async (req: Request, res: Response) => {
    await PrescriptionService.updatePrescriptionAndAppointment(
      req.user,
      req.body
    );
    sendResponse(res, {
...
const getDoctorPrescriptionById = catchAsync(
  async (req: Request, res: Response) => {
    const result = await PrescriptionService.getDoctorPrescriptionById(
      req.user
    );
    sendResponse(res, {
      statusCode: 200,
...
const getPatientPrescriptionById = catchAsync(
  async (req: Request, res: Response) => {
    const result = await PrescriptionService.getPatientPrescriptionById(
      req.user
    );
    sendResponse(res, {
      statusCode: 200,
