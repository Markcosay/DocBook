...
const createBlog = async (req: Request): Promise<Blog> => {
...
const getAllBlogs = async (filters: IBlogFilters, options: IOption): Promise<IGenericResponse<Blog[]>> => {
...
const updateBlog = async (req: Request): Promise<Blog | null> => {
    const file = req.file as IUpload;
